...
async function saveDataToSheet(data) {
    ...
    const valoresDeFila = [
        ...
        data.Colesterol,
        data.Depresion,
        data['Actividad fisica'],
        data.sedentarismo,
        data['Abuso alcohol y/o drogas'],
        data.Stress,
        data['Exceso preocupacion salud'],
        data['Exceso pantallas'],
        data.Fuma,
        data.Fumador_cronico,
        data['Hipertension familiar'],
        data['Diabetes familiar'],
        data['Adicciones familiar'],
        data['Obesidad familiar'],
        data['Depresion familiar'],
        data['Violencia familiar'],
